...
return {
  ...
  opts = {
    ...
    note_template_file = "/home/aletheios/SecondBrain/03_Templates/00_Plantilla_notas_atómicas.md",
    finder = "fzf-lua",
...
local function create_note_with_template()
  ...
  vim.ui.input({prompt = "Nombre de la nota: "}, function(input)
    ...
    -- Definir la ruta base de Zettelkasten
    local zettelkasten_path = "/home/aletheios/SecondBrain/01_Zettelkasten/"
    ...
    local template_path = "/home/aletheios/SecondBrain/03_Templates/00_Plantilla_notas_atómicas.md"
